...
(definition text) in full, as permitted by WordNet's license, reproduced here per that license's
own requirement that this notice "appear on ALL copies of the software, database and
